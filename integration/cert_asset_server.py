...
<body>
  <div class="card">
    ...
    <h2>iPhone / iPad</h2>
    <ol>
      <li>先确认 iPhone 与电脑处于同一局域网，并且可以访问当前电脑地址。</li>
      <li>在 iPhone 的 Wi-Fi 详情页中，将 HTTP 代理手动配置为抓包代理地址和端口。</li>
      <li>在 Safari 中打开当前 CA 下载地址。</li>
      <li>点击上方“下载 iOS 证书”，按系统提示下载安装描述文件。</li>
      <li>下载后前往 设置 → 已下载描述文件，完成证书安装。</li>
      <li>安装完成后，再前往 设置 → 通用 → 关于本机 → 证书信任设置。</li>
      <li>找到 mitmproxy 相关证书，手动开启“完全信任”。</li>
      <li>完成后，建议先用 Safari 打开任意 HTTPS 页面验证联网正常，再返回应用开始抓包。</li>
    </ol>
  </div>
</body>
</html>
