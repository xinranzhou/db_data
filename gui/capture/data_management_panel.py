...
def build_data_management_page(editor):
    ...
    editor.playwright_install_runtime_button = QPushButton("安装浏览器运行时")
    editor.playwright_install_runtime_button.clicked.connect(editor._install_playwright_runtime)
    ...
    batch_row.addWidget(editor.playwright_install_runtime_button)
